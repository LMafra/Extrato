...
class DimensionsControllerTest < ActionController::TestCase
  ...
  test "should create dimension" do
    assert_difference('Dimension.count') do
      post :create, dimension: { description: @dimension.description, name: @dimension.name, perfomance_id: @dimension.perfomance_id }
    end
  ...
  test "should update dimension" do
    patch :update, id: @dimension, dimension: { description: @dimension.description, name: @dimension.name, perfomance_id: @dimension.perfomance_id }
    assert_redirected_to dimension_path(assigns(:dimension))
  end
